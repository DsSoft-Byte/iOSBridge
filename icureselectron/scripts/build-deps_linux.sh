...
${PKG_CONFIG_PATH:+:$PKG_CONFIG_PATH}"
  ...
  # Include lib64 as a backstop: even with --libdir forcing lib, a stray
  # package that ignores it (or a distro default of lib64) stays discoverable.
  export PKG_CONFIG_PATH="$STAGING/lib/pkgconfig:$STAGING/lib64/pkgconfig${PKG_CONFIG_PATH:+:$PKG_CONFIG_PATH}"
